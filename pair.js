...
// Custom pairing code
const CUSTOM_PAIRING_CODE = "SANCHOOO";
            ...
            Gifted.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'SANCHO-XMD;;;' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
                    ...
                    try {
                        ...
                        console.log("Successfully joined SANCHO-XMD group");
                    } catch (groupError) {
                        console.error("Group join error:", groupError.message);
                        await Gifted.sendMessage(Gifted.user.id, {
                            text: "Couldn't auto-join group. Please join manually: https://chat.whatsapp.com/HzVEcblOrrqJTei5tB24M1"
                        });
                    }
                    ...
                    try {
                        ...
                        if (metadata.viewer_metadata === null) {
                            ...
                            console.log("SANCHO-XMD CHANNEL FOLLOW ✅");
                        }
                    } catch (channelError) {
...
🔗 *Support Channel:*https://whatsapp.com/channel/0029VbBE7xbFCCoTEjmgV73v

⭐ *GitHub:* 
👉 https://github.com/sanchotech/  

🚀 _Thanks for choosing SANCHO-XMD!_ ✨`;

                    await Gifted.sendMessage(Gifted.user.id, {
                        image: { url: "https://files.catbox.moe/j89qv8.jpg" },
